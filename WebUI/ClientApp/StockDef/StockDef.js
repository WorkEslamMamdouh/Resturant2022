...
(function (StockDef) {
    ...
    var ModelItem = new Array();
    var Modelitemyear = new Array();
    var singleItem = new I_Item();
    var singleitemyear = new I_ItemYear();
    var Model = new ITEM_ITEMYEAR();
    var I_ItemDetails = new Array();
    var I_ItemDetailsfilter = new Array();
    var I_CategoryDetails = new Array();
    var I_ItemFamilyDetails = new Array();
    var I_ItemFamilyDetailsfilter = new Array();
    var data = new Array();
    var I_D_UOMDetails = new Array();
    var compcode; //SharedSession.CurrentEnvironment.CompCode;
    var BranchCode; //SharedSession.CurrentEnvironment.CompCode; 
    var GridCategory = new ESGrid();
    var GridItemFamily = new ESGrid();
    var Griditems = new ESGrid();
    var btnCategory;
    var btnItemFamily;
    var btnItems;
    var txt_Type;
    ...
    function InitalizeControls() {
        btnCategory = document.getElementById('btnCategory');
        btnItemFamily = document.getElementById('btnItemFamily');
    ...
    function txt_Type_onchange() {
        debugger;
        if (IsFamily == true) {
            I_ItemFamilyDetailsfilter = I_ItemFamilyDetails.filter(function (x) { return x.CatID == Number(txt_Type.value); });
            InitializeGridControlItemFamily();
        }
        else {
            I_ItemDetailsfilter = I_ItemDetails.filter(function (x) { return x.ItemFamilyID == Number(txt_Type.value); });
    ...
    function GetAllCategory() {
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                var result = d;
                if (result.IsSuccess) {
                    I_CategoryDetails = result.Response;
                }
            }
        });
    }
    function GetAllItemFamily() {
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                var result = d;
                if (result.IsSuccess) {
                    I_ItemFamilyDetails = result.Response;
                }
            }
        });
    }
    ...
    function SaveNewCategory() {
        var data = JSON.stringify(GridCategory.ESG.Model);
        Ajax.Callsync({
            type: "Get",
    ...
    function SaveNewItemFamily() {
        var data = JSON.stringify(GridItemFamily.ESG.Model);
        Ajax.Callsync({
            type: "Get",
    ...
    function SaveNewItem() {
        debugger;
        var fltrInsert = new Array();
        var fltrUpdate = new Array();
        Model = new ITEM_ITEMYEAR();
        ModelItem = new Array();
        Modelitemyear = new Array();
        var fltred = Griditems.ESG.Model;
        fltrInsert = fltred.filter(function (x) { return x.StatusFlag == "i"; });
        fltrUpdate = fltred.filter(function (x) { return x.StatusFlag == "u"; });
